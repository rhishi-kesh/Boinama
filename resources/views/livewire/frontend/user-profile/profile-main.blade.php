            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-3">
                        <ul class="list-group">
                            <a class="list-group-item active" href="{{ route('dashboard') }}">
                    ...
                    <div class="col-12 col-lg-9 mt-0 mt-md-2 mt-lg-0">
                        <div class="row">
                            <div class="col-12 col-md-4 mt-2 mt-md-0">
                                <a href="{{ route('all_pending_order') }}">
                                    <div class="card shadow p-4 border-0 text-center">
                                        <h2 class="h1 color-orange">
                                            <i class="fas fa-spinner mr-2"></i>
                                        </h2>
                                        <p class="h4 mt-2 text-dark">Pending Orders</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-12 col-md-4 mt-2 mt-md-0">
                                <a href="{{ route('all_delivered_order') }}">
                                    <div class="card shadow p-4 border-0 text-center">
                                        <h2 class="h1 color-orange">
                                            <i class="far fa-thumbs-up mr-2"></i>
                                        </h2>
                                        <p class="h4 mt-2 text-dark">Delivered Orders</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-12 col-md-4 mt-2 mt-md-0">
                                <a href="{{ route('all_cancel_order') }}">
                                    <div class="card shadow p-4 border-0 text-center">
                                        <h2 class="h1 color-orange">
                                            <i class="fas fa-ban mr-2"></i>
                                        </h2>
                                        <p class="h4 mt-2 text-dark">Cenceled Orders</p>
                                    </div>
                                </a>
                            </div>
                        </div>
