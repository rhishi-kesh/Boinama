                                    ...
                                    <div class="row is-grid-active">
                                        ...
                                        <div class="card">
                                           <div class="card-body p-4 d-flex justify-content-start">
                                                <div>
                                                    <img src="{{ asset('storage/' . $alllwriter->writer_image) }}" alt="" width="100" height="100" style="border-radius: 50%; object-fit: cover;">
                                                </div>
                                                <div class="ms-4">
                                                    <h4 class="fs-3 mb-2" style="font-weight: 500">{{ $alllwriter->name }}</h4>
                                                    <p>{{ $alllwriter->description }}</p>
                                                </div>
                                           </div>
                                        </div>
                                    </div>
