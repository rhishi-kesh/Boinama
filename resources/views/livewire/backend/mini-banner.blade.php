                        ...
                        <table class="table text-center mb-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $Banner->image) }}" alt="img" width="150">
                                    </td>
                                    <td>{{ $Banner->link }}</td>
                                    <td class="switch-sm">
                                        <label class="switch">
                                            <input type="checkbox" wire:change="status({{ $Banner->id }})" @if($Banner->status == 0) checked @endif>
                                            <span class="switch-state"></span>
                                        </label>
                                    </td>
                                    <td>
                                        <button wire:click="changeEdit({{ $Banner->id }})" class="border-0 btn-success active ps-3 pe-3 mt-1 py-2 fs-6" style="cursor: pointer">
                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                        </button>
                                        <button  wire:click="deletecategory({{ $Banner->id }})" class="border-0 px-3 py-2 btn-secondary mt-1 active fs-6" style="cursor: pointer">
            ...
            <div class="card">
                <form class="theme-form" Wire:submit="update">
                    ...
                    <div class="card-header pb-0">
                        <h5>Edit MiniBanners</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="SliderImage">Banner Image</label>
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="SliderLink">Banner Link</label>
