<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="mt-3 col-6">
                                ...
                                @if ($image)
                                    ...
                                    <img style="width: 60px; height: 90px;" src="{{ $image->temporaryUrl() }}">
                                @endif
                                @if ($errors->has('image'))
                            ...
                            <div class="mt-3 col-6  align-self-start">
                                ...
                                <input type="file" wire:model="preview"
                                    class="form-control @error('preview') is-invalid @enderror" id="preview"
    ...
    @else
        <div class="col-sm-12 table-dta">
            <div class="card">
                <div class="card-body">
                    <button class="btn btn-primary" wire:click="removeadd">Add New Product</button>
                </div>
            </div>
            <div class="card">
                <div class="card-header pb-0">
