                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mt-3 col-6 align-self-start">
                                <label for="preview" class="form-label">Product Preview <span
                                    class="text-danger">*</span></label>
                            ...
                            <div class="mt-3 col-6">
                                <label class="form-label pt-0" for="description">Description <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-7">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><b>Product Writer:</b> {{ $writer_id ?? "N/A" }}</li>
                                <li class="list-group-item"><b>Product Subject:</b> {{ $subject_id ?? "N/A" }}</li>
                                <li class="list-group-item"><b>Product Prokashoni:</b> {{ $prakasani_id ?? "N/A" }}</li>
                                <li class="list-group-item"><b>Product Description:</b> {{ $description ?? "N/A" }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div id="basic-3_wrapper" class="dataTables_wrapper">
                            ...
                            <table class="display dataTable mb-2" id="basic-3" role="grid"
                                aria-describedby="basic-3_info">
                                <thead>
                                    <tr role="row">
                                        <th scope="col">SL</th>
                                        ...
                                        <th scope="col" style="width: 30px">Product Original Price</th>
                                ...
                                <tbody>
                                    @forelse ($Products as $key => $Product)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $Product->subjects_id->name ?? "N/A" }}</td>
                                            <td>{{ $Product->prakasanis_id->name ?? "N/A" }}</td>
                                            <td>{{ $Product->writers_id->name ?? "N/A" }}</td>
                                            <td class="switch-sm text-center" style="width: 10px; padding: 0 15px">
                                                <label class="switch">
                                                    <input type="checkbox" wire:change="status({{ $Product->id }})" @if($Product->is_active == 0) checked @endif>
                                                    <span class="switch-state"></span>
                                                </label>
                                            </td>
                                            <td style="width: 10px; padding: 0 15px">
                                                <a wire:click="showview({{ $Product->id }})"
                                                    class="d-block px-2 py-1 btn-info active text-center"
                                                    style="cursor: pointer">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a wire:click="showEdit({{ $Product->id }})"
                                                    class="d-block px-2 py-1 btn-success active text-center"
                                                    style="cursor: pointer">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                                <a wire:click="delete({{ $Product->id }})"
                                                    class="d-block px-2 py-1 btn-secondary active text-center"
                                                    style="cursor: pointer">
